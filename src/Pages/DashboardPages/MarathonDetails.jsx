...
//   const remainingTime = Math.max(marathonStart - now, 0); // in seconds
...
//               <MdOutlineDateRange className="text-green-600 mt-1" />
//               <span>
...
//                   className="inline-block bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3 rounded-lg transition-all duration-200 shadow-md"
//                 >
//                   Register Now
//                 </Link>
//               ) : (
...
//         <h1 className="text-center text-3xl font-bold animate-bounce bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
//           Countdown
//         </h1>

//         <div className="max-w-4xl mx-auto px-4 py-8 App">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="mt-6">
              {isRegistrationOpen ? (
                <Link
                  to={`/marathons/register/${marathon._id}`}
                  className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg transition duration-200 shadow"
                >
                  Register Now
                </Link>
              ) : (
